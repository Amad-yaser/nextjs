...
export default function ContactPage() {
  ...
  const faqs = [
    {
      question: "ما هو متوسط وقت تنفيذ المشاريع؟",
      answer: "تختلف مدة المشاريع حسب التعقيد. الموقع البسيط قد يستغرق 4-6 أسابيع، بينما التطبيق المعقد قد يستغرق 3-6 أشهر."
    },
    {
      question: "هل تقدمون دعماً وصيانة مستمرة؟",
      answer: "نعم، نقدم باقات دعم وصيانة شاملة لضمان عمل تطبيقك بسلاسة بعد الإطلاق."
    },
    {
      question: "ما هي التقنيات التي تتخصصون فيها؟",
      answer: "نتخصص في React, Next.js, Node.js, TypeScript والتقنيات الحديثة للويب. كما نعمل مع أطر تطوير الجوال المختلفة."
    },
    {
      question: "كيف تتعاملون مع تسعير المشاريع؟",
      answer: "نقدم خيارات تسعير ثابتة وسعرية بالساعة. يعتمد التسعير على نطاق المشروع والتعقيد ومتطلبات الجدول الزمني."
    }
  ];
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-gray-700">
        ...
        <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl md:text-2xl lg:text-3xl mb-8 max-w-3xl mx-auto">
            دعنا نناقش مشروعك ونحول أفكارك إلى واقع
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                ...
                نتشوق لسماع مشروعك ومناقشة كيف يمكننا مساعدتك.
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="mobile-development">تطوير الجوال</option>
                    <option value="ui-ux-design">تصميم واجهة المستخدم</option>
      ...
      <section className="py-20 bg-gradient-to-r from-gray-900 to-gray-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            دعنا نعمل معاً لخلق شيء رائع. تواصل معنا ودعنا نناقش مشروعك.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact">
              <Button size="lg" className="bg-yellow-400 text-gray-900 hover:bg-yellow-300">
