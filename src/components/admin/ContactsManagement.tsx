  ...
  const [contacts, setContacts] = useState<Contact[]>([
    {
      ...
      phone: '+966501234567',
      subject: 'استفسار عن تطوير متجر إلكتروني',
      message: 'أرغب في تطوير متجر إلكتروني متكامل لمنتجاتي. هل يمكنكم تزويدي بالتفاصيل والأسعار؟',
      status: 'new',
    ...
    },
    {
      ...
      subject: 'شكوى تقنية',
      message: 'واجهت مشكلة في تحميل الموقع الذي اشتريته. الرابط لا يعمل.',
      status: 'read',
    ...
    },
    {
      ...
      message: 'أقترح إضافة ميزة الدفع بالبطاقة الائتمانية لتسهيل عملية الشراء.',
      status: 'replied',
      notes: 'تم الرد وشكره على الاقتراح',
