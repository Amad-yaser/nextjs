  ...
  const [websites, setWebsites] = useState<Website[]>([
    {
      ...
      images: [
        '/template-ecommerce.jpg',
        '/template-ecommerce-2.jpg',
        '/template-ecommerce-3.jpg',
        '/template-ecommerce-4.jpg'
      ],
      createdAt: '2024-01-15',
      description: 'متجر إلكتروني احترافي مع جميع الميزات اللازمة للبيع عبر الإنترنت',
      features: ['سلة التسوق', 'بوابة الدفع', 'إدارة المنتجات', 'تتبع الطلبات'],
      ...
      status: 'active',
      tags: ['تجارة إلكترونية', 'متجر', 'دفع إلكتروني']
    },
    {
      id: '2',
      title: 'مطعم أنيق',
      ...
      reviewCount: 23,
      provider: 'فاطمة علي',
      image: '/template-restaurant.jpg',
      images: [
        '/template-restaurant.jpg',
        '/template-restaurant-2.jpg',
        '/template-restaurant-3.jpg'
      ],
      createdAt: '2024-01-10',
      description: 'موقع مطعم أنيق مع نظام حجوزات وقوائم طعام تفاعلية',
      features: ['نظام الحجوزات', 'القائمة الرقمية', 'التوصيل', 'التقييمات'],
      technologies: ['HTML5', 'CSS3', 'JavaScript', 'PHP'],
      demoUrl: 'https://restaurant-demo.example.com',
      supportEmail: 'restaurant@example.com',
      documentation: 'https://restaurant-docs.example.com',
      lastUpdated: '2024-01-18',
      status: 'active',
      tags: ['مطعم', 'حجوزات', 'قائمة طعام']
    },
    {
      id: '3',
      ...
      images: [
        '/template-portfolio.jpg',
        '/template-portfolio-2.jpg',
        '/template-portfolio-3.jpg',
        '/template-portfolio-4.jpg',
        '/template-portfolio-5.jpg'
      ],
      createdAt: '2024-01-05',
      description: 'معرض أعمال احترافي للمصممين والمبدعين',
      features: ['معرض الصور', 'معرض الفيديو', 'المدونة', 'اتصل بنا'],
      technologies: ['Next.js', 'Tailwind CSS', 'Framer Motion', 'Vercel'],
      demoUrl: 'https://portfolio-demo.example.com',
      supportEmail: 'portfolio@example.com',
      documentation: 'https://portfolio-docs.example.com',
      lastUpdated: '2024-01-22',
      status: 'active',
      tags: ['معرض أعمال', 'مصمم', 'مبدع']
    }
  ]);
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto" dir="rtl">
          ...
          <DialogFooter className="mt-6">
            ...
            <Button onClick={handleSaveWebsite} className="bg-green-600 hover:bg-green-700">
